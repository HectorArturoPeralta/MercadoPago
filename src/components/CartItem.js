...
import { decrementQuantity, deleteItem, resetCart, increamentQuantity } from "../redux/bazarSlice";
          ...
          >
            <div className="flex items-center gap-2">
              <MdOutlineClose
                ...
                className="text-cl text-gray-600 hover:text-red-600 cursor-pointer duration-300"
              />
              <img
